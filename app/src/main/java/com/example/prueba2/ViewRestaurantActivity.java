...
public class ViewRestaurantActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null) {
            ...
            float averageRating = intent.getFloatExtra("average_rating", 3.5f);
            resName = name;
            ...
            ratingBarAvg.setRating(averageRating);
        }
    ...
    protected void onResume() {
        super.onResume();
        // Controlla se l'adapter è diverso da null e chiamalo solo se è necessario aggiornare la vista
        if (adapter != null) {
            adapter.notifyDataSetChanged(); // Aggiorna tutti gli elementi nella RecyclerView
        }
    }
}
